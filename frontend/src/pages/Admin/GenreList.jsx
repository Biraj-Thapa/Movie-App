...
const GenreList = () => {
  ...
  const handleCreateGenre = async (e) => { e.preventDefault();
    ...
    <div className="ml-[10rem] flex flex-col md:flex-row">
      <div className="md:w-3/4 p-3">
        ...
        <Modal isOpen={modalVisible} onClose={() => setModalVisible(false)}>
          <GenreForm value={updatingName} setValue={(value) => setUpdatingName(value)} handleSubmit={handleUpdateGenre} buttonText="Update" handleDelete={handleDeleteGenre}/>
        </Modal>
      </div>
    </div>
  );
